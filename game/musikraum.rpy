init python:
    ...
    tracks.addTrack("KRIEG IST PRIMA!", "music/main_menu_theme.ogg")
    tracks.addTrack("Im Keller...", "music/bernd_theme.ogg")      
    tracks.addTrack("Pause muss auch mal sein", "music/bernd_wohnung.ogg")
    tracks.addTrack("Kaufe das Kokiri-Schild, geh zum Deku-Baum", "music/shop.ogg")
    tracks.addTrack("Salih-Time", "music/donerladen.ogg")
    tracks.addTrack("So stand sie vor mir~", "music/anja_theme.ogg")     
    tracks.addTrack("unbekannte Wohnung", "music/anja_wohnung.ogg")
    tracks.addTrack("Jamba", "music/anja_handy.ogg")
    tracks.addTrack("Das Lied ist schon traurig...", "music/sad.ogg")
    tracks.addTrack("...aber nicht so traurig wie dieses hier! ;_;", "music/;_;.ogg")
    tracks.addTrack("So arreine...", "music/ronery.ogg")
    tracks.addTrack("Laura ist soooooooooo süß!", "music/laura_theme.ogg")
    tracks.addTrack("Warum ist das Leben nur so ungerecht?", "music/liebe.ogg")
    tracks.addTrack("Jetzt ist sie auch noch krank...", "music/krank.ogg")
    ...
    #tracks.addTrack("Schon vorbei?", "con te partiro.mp3")
    ...
    #tracks.addTrack("Entspann dich doch mal", "music/cafe.ogg")
