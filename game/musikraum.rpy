init python:
    ...
    tracks.addTrack("Titelbildschirm", "music/main_menu_theme.ogg")
    tracks.addTrack("Arrein, arrein...", "music/ronery.ogg")
    ...
    tracks.addTrack("Thema eines Helden", "music/bernd_theme.ogg")      
    ...
    tracks.addTrack("Wie kam ich auf Namen für die Musikstücke?", "music/exciting.ogg")
    tracks.addTrack("Das ist sowieso das einzige Lied, das gehört werden wird", "music/laura_theme.ogg")
    tracks.addTrack("Ich sterbe fast vor Anspannung...fast", "music/psycho.ogg")
    ...
    tracks.addTrack("Hier fiel mir überhaupt kein Name ein", "music/Treffen, das niemals stattfinden sollte.ogg")
    tracks.addTrack("Stalk, stalk...", "music/yasmin_stalkerbernd_theme.ogg")
    tracks.addTrack("[drei Punkte in diesem Feld]", "music/yasmin_theme.ogg")
    tracks.addTrack("...Wohnung", "music/yasmin_wohnung.ogg") 
